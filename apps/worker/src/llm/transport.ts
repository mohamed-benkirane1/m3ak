...
// TASK-028: worker-owned copy of apps/api/src/llm/transport.ts, kept in
// parity byte-for-byte (HACK-CTRL decision, TASK-028B) — including its Zod-
// based validation, now that @m3ak/worker declares zod as a direct
// production dependency. Never imported cross-workspace from apps/api;
// never moved into @m3ak/shared.
...
// this project builds. Provider-mechanical only: no env reads, no model-
// selection policy, no business logic, no retries.
//
